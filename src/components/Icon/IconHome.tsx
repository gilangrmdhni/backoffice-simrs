...
const IconHome: FC<IconHomeProps> = ({ className, fill = false, duotone = true,color = "" }) => {
    return (
        <>
            {!fill ? (
                <svg width="20" height="20" viewBox="0 0 24 24" fill={`${color !== "" ? color : "currentColor"}`} xmlns="http://www.w3.org/2000/svg" className={className}>
                    <path
                        ...
                        strokeWidth="1.5"
                    />
                    <path d="M12 15L12 18" stroke={`${color !== "" ? color : "currentColor"}`} strokeWidth="1.5" strokeLinecap="round" />
                </svg>
            ) : (
                <svg width="24" height="24" viewBox="0 0 24 24" fill={`${color !== "" ? color : "currentColor"}`} xmlns="http://www.w3.org/2000/svg" className={className}>
                    <path
                        opacity={duotone ? '0.5' : '1'}

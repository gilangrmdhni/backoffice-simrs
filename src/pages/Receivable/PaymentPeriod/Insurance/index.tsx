...
const Insurance = () => {
    ...
    const {
        ...
        refetch: insurnanceListOptionRefetch,
            ...
            <div className="panel mt-6">
                ...
                <div className="datatables">
                    <table>
                        ...
                        <tbody>
                            {
                                insuranceList?.data?.map((data:agingScheduleInsuranceType,index : number) => {
                                    ...
                                    return(
                                        <>
                                            <tr key={index}>
                                                ...
                                                <td>
                                                    <span className={` text-bold ${data.status == "Past Due" || data.status == "Over Due Due" ? 'text-red-600' : data.status == "Due Soon" ? 'text-orange-600' : 'text-sky-600'}`} > 
                                                        {data.status} 
                                                    </span>
                                                </td>
